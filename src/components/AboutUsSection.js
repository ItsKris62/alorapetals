import aboutUsImage from "../assets/images/flowers_production.jpg";
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center space-y-10 lg:space-y-0 lg:space-x-10">
        ...
        <div className="w-full lg:w-1/2">
          <p className="text-lg font-lato text-gray-700 mb-4 transition-opacity duration-500 hover:opacity-80">
            ...
            exporting fresh flowers to the Middle East, Asia, Europe and Africa,
          ...
          <p className="text-lg font-lato text-gray-700 mb-6 transition-opacity duration-500 hover:opacity-80">
            ...
            retailers and even event planners, our diverse range of fresh cut
            flowers ensures we meet your specific floral needs. At Alora Petals
            we pride ourselves on delivering exceptional customer service and
            timely shipments, thanks to our advanced cold chain logistics and
