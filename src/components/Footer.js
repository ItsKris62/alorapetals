...
const Footer = () => {
  ...
  return (
    <footer className="bg-indigo-50  text-black py-10 relative">
    {/* Footer Content */}
    <div className={`container mx-auto px-4 transition-all ${isScrolled ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} ease-out duration-500`}>
      ...
      {/* Social Media Icons */}
      <div className="flex justify-center mt-8 space-x-4"> {/* Updated this line to use space-x-4 */}
        {/* Facebook Button */}
          ...
          <button className="relative w-12 h-12 rounded-full group">
            ...
            <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
              <svg height="32" width="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path className="group-hover:fill-[#171543] fill-white duration-300" d="M28 5H4c-1.104 0-2 .896-2 2v18c0 1.104.896 2 2 2h24c1.104 0 2-.896 2-2V7c0-1.104-.896-2-2-2zm0 4.879L16 18 4 9.879V7l12 8 12-8v2.879zM4 23V11.885l11.446 7.63c.269.18.594.274.921.274s.652-.094.92-.274L28 11.885V23H4z" fill="#FFFFFF"></path>
              </svg>
            </div>
          </button>
        </div>
