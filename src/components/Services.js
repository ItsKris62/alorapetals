  ...
  return (
    <div className="services-page bg-gray-50 min-h-screen py-16">
      ...
      <div className="hero bg-gradient-to-r from-purple-500 to-pink-500 text-white text-center py-20">
        ...
        <button className="mt-8 px-6 py-3 bg-white text-purple-600 hover:bg-gray-200 rounded-full font-semibold shadow-lg transition-all duration-300">
          Contact Us
        </button>
      </div>
      ...
      <section className="cta bg-purple-100 py-10 text-center">
        ...
        <button className="mt-6 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-full font-semibold shadow-lg transition-all duration-300">
          Get in Touch
        </button>
      </section>
    </div>
