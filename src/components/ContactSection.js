      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-montserrat text-lg">Our office</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-montserrat text-lg">Send us an email</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-montserrat text-lg">Give us a ring</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-montserrat text-lg">Send us a message</p>
            <p className="text-gray-500">+254 710 272174</p>
          </div>
